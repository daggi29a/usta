   ...
   handleClick(e) {
     ...
     api.postVeranstaltung(data)
       .then(result => {
         console.log('SUCCESS!')
         this.setState({
          message: `Veranstaltung'${this.state.name}' wurde erstellt`
         })
         setTimeout(() => {
           this.setState({
             message: null
        ...
        <div className="row">
          <div className="col-sm veranstaltungForm">
            ...
            <Label for="exampleSelect">Laden</Label>
              <Input type="select" select value={this.state.laden} onChange={(e) => {this.handleInputChange("laden", e)}}>
              ...
              <FormGroup check>
                <Label check>
                  <Input type="checkbox" value={this.state.vmensch}
              ...
              <FormGroup check>
                <Label check>
                  <Input type="checkbox" value={this.state.aufbau}
              ...
              <FormGroup check>
                <Label check>
                  <Input type="checkbox" value={this.state.catering}
              ...
              <FormGroup check>
                <Label check>
                  <Input type="checkbox" value={this.state.sonstiges}
            ...
            <Form inline>
              <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                <Label for="kassenschichten" className="mr-sm-2">Kassenschichten</Label>
              ...
              <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                <Label for="leuteProKasse" className="mr-sm-2">Leute</Label>
            ...
            <Form inline>
              <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                <Label for="kassenschichten" className="mr-sm-2">Thekenschichten</Label>
              ...
              <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                <Label for="leuteProSchicht" className="mr-sm-2">Leute</Label>
              ...
              <Form inline>
              <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                <Label for="sonstigesAnzahl" className="mr-sm-2">Sonstigesschichten</Label>
              ...
              <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
                <Label for="leuteProSonstiges" className="mr-sm-2">Leute</Label>
              ...
              <br />
              <Form>
              <Button onClick={(e) => this.handleClick(e)}>Absenden</Button>
            </Form>
          </div>
{/* PAGEBREAK */}
